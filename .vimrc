...
" If the current file type is HTML or XML, set indentation to 2 spaces.
...
" Do not Show mode in the last line of the screen
  set noshowmode
...
" Colors
	...
	hi User1 ctermbg=grey ctermfg=white guibg=black guifg=white
	hi User3 ctermbg=grey  ctermfg=blue guibg=black guifg=lightblue
	hi User4 ctermbg=grey ctermfg=blue guibg=black guifg=lightgreen
